...
parser.add_argument('--generation_model', type=str, default='Llama-2-7b')
...
model = AutoModelForSequenceClassification.from_pretrained("microsoft/deberta-xlarge-mnli").cuda()
