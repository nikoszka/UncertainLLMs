...
parser.add_argument('--evaluation_model', type=str, default='Llama-2-7b-hf')
...
model = AutoModelForCausalLM.from_pretrained(f"meta-llama/{args.evaluation_model}",
                                             torch_dtype=torch.float16,
                                             cache_dir=config.data_dir).cuda()
tokenizer = AutoTokenizer.from_pretrained(f"meta-llama/{args.evaluation_model}",
                                          use_fast=False,
